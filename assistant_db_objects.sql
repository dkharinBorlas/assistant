...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ASSISTANT"."ACC_ALLOCATIONS_S"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 51 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ASSISTANT"."ACC_ALLOCATION_PAYS_S"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 10 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "ASSISTANT"."ACC_ALLOCATIONS_V" ("ID_", "NAME_", "ARTICLE_ID_", "ARTICLE_NAME_", "DATE_", "SUMM_", "SUMM_HAVE_", "SUMM_HAVE_PROCENT_", "SUMM_MIN_", "CURREN_", "MANDATORY_") AS 
  select a.id_,
       a.name_,
...
Insert into ASSISTANT.ACC_LOOKUP_T (ID_,NAME_,VALUE_DISPLAY_,VALUE_RETURN_,OUTPUT_PRIORITET_) values (12,'ACC_OBJECTS','MINUS','ACC_MINUS_T',null);
...
Insert into ASSISTANT.ACC_LOOKUP_T (ID_,NAME_,VALUE_DISPLAY_,VALUE_RETURN_,OUTPUT_PRIORITET_) values (41,'ACC_OBJECTS_PARENT_COLUMNS','MINUS','MINUS_ID_',null);
